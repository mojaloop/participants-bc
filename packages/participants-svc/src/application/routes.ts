...
export class ExpressRoutes {
  ...
  constructor(
    ...
    this._mainRouter.get(
      ...
      this.getParticipantsByIds.bind(this)
    );
    ...
    this._mainRouter.put(
      ...
      this.participantApprove.bind(this)
    );
    this._mainRouter.put(
      "/participants/:id/disable",
      this.deactivateParticipant.bind(this)
    );
    this._mainRouter.put(
      "/participants/:id/enable",
      this.activateParticipant.bind(this)
    );

    // endpoint
    this._mainRouter.get(
      "/participants/:id/endpoints",
      this.endpointsByParticipantId.bind(this)
    );
    this._mainRouter.post(
      "/participants/:id/endpoints",
      this.participantEndpointCreate.bind(this)
    );
    this._mainRouter.put(
      "/participants/:id/endpoints/:endpointId",
      this.participantEndpointChange.bind(this)
    );
    this._mainRouter.delete(
      "/participants/:id/endpoints/:endpointId",
      this.participantEndpointDelete.bind(this)
    );

    // account
    this._mainRouter.get(
      "/participants/:id/accounts",
      this.accountsByParticipantId.bind(this)
    );
    this._mainRouter.post(
      "/participants/:id/account",
      this.participantAccountCreate.bind(this)
    );
    // this._mainRouter.delete("/participants/:id/account", this.participantAccountDelete.bind(this));

    // funds management
    this._mainRouter.post(
      "/participants/:id/funds",
      this.participantFundsMovCreate.bind(this)
    );
    this._mainRouter.post(
      "/participants/:id/funds/:fundsMovId/approve",
      this.participantFundsMovApprove.bind(this)
    );

    // simulate transfers
    this._mainRouter.post(
      "/simulatetransfer",
      this.simulateTransfer.bind(this)
    );
  }
  ...
  private async getParticipantsByIds(
    req: express.Request,
    res: express.Response
  ) {
  ...
  private async participantApprove(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async deactivateParticipant(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async accountsByParticipantId(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async participantAccountCreate(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async endpointsByParticipantId(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async participantEndpointCreate(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async participantEndpointChange(
    req: express.Request,
    res: express.Response
  ) {
  ...
  private async participantEndpointDelete(
    req: express.Request,
    res: express.Response
  ) {
    const participantId = req.params["id"] ?? null;
  ...
  private async participantFundsMovCreate(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
  ...
  private async participantFundsMovApprove(
    req: express.Request,
    res: express.Response
  ) {
    const id = req.params["id"] ?? null;
