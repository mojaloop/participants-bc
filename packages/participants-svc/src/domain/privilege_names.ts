...
export enum ParticipantPrivilegeNames {
    ...
    REJECT_PARTICIPANT_ACCOUNT_CREATION_REQUEST = "REJECT_PARTICIPANT_ACCOUNT_CREATION_REQUEST",
    APPROVE_PARTICIPANT_ACCOUNT_BANK_DETAILS_CHANGE_REQUEST = "APPROVE_PARTICIPANT_ACCOUNT_BANK_DETAILS_CHANGE_REQUEST",
    REJECT_PARTICIPANT_ACCOUNT_BANK_DETAILS_CHANGE_REQUEST = "REJECT_PARTICIPANT_ACCOUNT_BANK_DETAILS_CHANGE_REQUEST",
